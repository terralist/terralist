  ...
  <div
    ...
    <div class="relative w-full h-full flex justify-center items-center">
      <div
        ...
        class="relative w-full max-w-2xl bg-slate-50 rounded-lg shadow dark:bg-slate-900">
        <div
          class="flex items-start justify-between p-4 border-b rounded-t bg-teal-400 dark:bg-teal-700 dark:border-slate-600 dark:text-white">
        ...
        <div
          class="p-6 max-h-96 text-slate-600 dark:text-slate-200 overflow-auto">
          <slot name="body"></slot>
        </div>
        {#if $$slots.footer}
          <div
            class="flex items-center text-xs text-slate-600 dark:text-slate-200 p-3 space-x-2 border-t border-slate-200 rounded-b dark:border-slate-600">
