  ...
  <a
    ...
    <div class="flex-1 min-w-0">
      <div class="flex items-center gap-2">
        ...
        <span class="px-2 py-0.5 text-xs font-medium rounded-full bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-300">
          {artifact.type}
        </span>
      </div>
    ...
    <div class="hidden sm:flex items-center gap-6 text-sm text-gray-500 dark:text-gray-400">
      <div class="text-center">
        <p class="font-medium text-gray-900 dark:text-white">{artifact.versions[0]}</p>
        <p class="text-xs">version</p>
      </div>
      <div class="text-center">
        <p class="font-medium text-gray-900 dark:text-white">{timeSince(artifact.updatedAt)}</p>
        <p class="text-xs">updated</p>
      </div>
    </div>
    <Icon name="arrow-forward" width="1.25rem" height="1.25rem" class="text-gray-400" />
  </a>
{/if}
